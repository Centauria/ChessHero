	...
	def _build_net(self):
		...
		with tf.variable_scope('eval-net'):
			...
			with tf.variable_scope('conv1'):
				w_conv1 = tf.get_variable('w_conv1', [4, 8, 128], \
										  initializer=w_initializer, collections=c_names)
				b_conv1 = tf.get_variable('b_conv1', [128], \
										  initializer=b_initializer, collections=c_names)

			# second layer.
			with tf.variable_scope('conv2'):
				w_conv2 = tf.get_variable('w_conv2', [2, 128, 256], \
										  initializer=w_initializer, collections=c_names)
				b_conv2 = tf.get_variable('b_conv2', [256], \
										  initializer=b_initializer, collections=c_names)

			# first full link layer.
			with tf.variable_scope('fc1'):
				w_fc1 = tf.get_variable('w_fc1', [512, 2000], \
										initializer=w_initializer, collections=c_names)
			...
			with tf.variable_scope('fc2'):
				w_fc2 = tf.get_variable('w_fc2', [2000, self.actions], \
										initializer=w_initializer, collections=c_names)
